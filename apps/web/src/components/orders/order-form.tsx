...
export function OrderForm({ customers, opportunities, products, quotes }: OrderFormProps) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const body = {
      ...
      sourceQuoteId: String(formData.get("sourceQuoteId") || ""),
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gap: "0.25rem" }}>
        <label style={{ fontSize: "0.875rem", fontWeight: 600 }}>Cotización origen (opcional)</label>
        <select
          name="sourceQuoteId"
          style={{
            padding: "0.5rem 0.75rem",
      ...
      <div style={{ display: "grid", gap: "0.25rem" }}>
        <label style={{ fontSize: "0.875rem", fontWeight: 600 }}>Fecha de entrega solicitada</label>
        <input
