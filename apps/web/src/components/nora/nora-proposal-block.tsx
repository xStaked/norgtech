...
export function NoraProposalBlock({
  title,
  description,
  enabled,
  onToggle,
  ...
  return (
    <section
      style={{
        ...
        borderRadius: 14,
        overflow: "hidden",
        border: `1px solid ${enabled ? crmTheme.nora.border : crmTheme.colors.border}`,
    ...
    >
      <div
        style={{
          ...
          gap: 12,
          padding: "12px 16px",
          background: enabled ? crmTheme.nora.gradient : crmTheme.colors.surfaceMuted,
      ...
      >
        ...
        <NoraToggle checked={enabled} onChange={onToggle} label={toggleLabel} />
      </div>
